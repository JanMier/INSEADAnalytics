...
2. 0.93
3. I would call them
 + Component 1: Government bonds
 + Component 2: Currencies
 + Component 3: European stock indexes
 + Component 4: North American stock indexes
 + Component 5: European f/x futures and securities
 + Component 6: Oil
 + Component 7: Cu, Zn, Al, Ni
 + Component 8: Soy, Corn and Wheat trifecta
 + Component 9: Precious metals
 + Component 10: East Asian stock indexes
4. Let's have a go..
```{r echo=FALSE, comment=NA, warning=FALSE, error=FALSE,message=FALSE, results='asis'}
rotation_used="varimax"
MIN_VALUE=0.5
```
 + pre-crisis bull market years (November 1, 2002, and October 1, 2007)
```{r pre-crisis, echo=FALSE, comment=NA, results='asis', message=FALSE, fig.align='center', fig=TRUE}
...
print(m1,'chart')
```
 + financial crisis years (October 1, 2007 and March 1, 2009)
```{r crisis, echo=FALSE, comment=NA, results='asis', message=FALSE, fig.align='center', fig=TRUE}
...
print(m1,'chart')
```
5. In the bull market there are 8 principal components and the in the bear market only 4 (however with more variables). Aassets become much more correlated during the crisis.
+ Both have the same stock indexes
+ Currencies and metals are separate components pre-crisis and are grouped together during the crisis
+ European and North American bonds were separate components pre-crisis and are grouped together during the crisis
+ Soy, Wheat, Corn and Oil are 2 components pre-crisis and one component during the crisis
<br>
<br>
<br>
<br>
...
**Your Answers here:**
1. Not any better than what is in the comments
2. I get different returns e.g.
+ I can increase the investment amount to get higher returns and higher volatility
+ I can change the MAfreq sequence increment, which increases the returns
<br>
<br>
<br>
<br>
